...
public class SuggestedController {
    ...
    public ResponseEntity<ResponseDto<String>> suggestedTeamToCavalier(@PathVariable long idUser) throws BusinessException {
        return ResponseEntity.ok(new ResponseDto<>(suggestedService.suggestTeamToCavalier(idUser)));
    }
}
